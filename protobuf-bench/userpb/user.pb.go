...
type User struct {
	...
	SignupTimestamp int64                  `protobuf:"varint,6,opt,name=signup_timestamp,json=signupTimestamp,proto3" json:"signup_timestamp,omitempty"`
...
func (x *User) GetSignupTimestamp() int64 {
	if x != nil {
		return x.SignupTimestamp
	}
	return 0
}
...
const file_user_proto_rawDesc = "" +
	...
	"\x10signup_timestamp\x18\x06 \x01(\x03R\x0fsignupTimestampB\n" +
